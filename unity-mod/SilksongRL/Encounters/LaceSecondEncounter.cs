...
namespace SilksongRL
{
    ...
    public class LaceSecondEncounter : IBossEncounter
    {
        ...
        // If hornet gets stuck in this fight, figure out where it happens,
        // uncomment this and define isHeroStuck() (currently returns false)
        // For reference, see LaceEncounter.cs
        // private const float STUCK_Y_THRESHOLD = 5f; (example values)
        // private const float STUCK_X_THRESHOLD = 5f; (example values)
